...
import img3 from "../../assets/images/logo/github.png"
      ...
      <div className="footer-main">
        ...
        <div className="container">
          <ul className="widget-social">
            ...
            {/* <li>
                            <a href="https://twitter.com/VirtualPeradox" target='_blank' rel='noreferrer'>
            ...
            <li>
              <a
                href="https://t.me/VirtualRaceWorldofPeradox"
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <li>
              ...
              >
                ...
                {/* <img src={img3} alt="github" width={32} height={32} /> */}
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              <a
                href="https://youtube.com/@VirtualRacePeradox"
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <li>
              <a
                href="http://www.tiktok.com/@virtual_peradox_race"
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <li>
              <a
                href="https://www.instagram.com/invites/contact/?i=v9lcafja2vgx&utm_content=rlsvrbl"
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=100093903214353&mibextid=LQQJ4d"
                target="_blank"
                rel="noreferrer"
              >
                <svg
